...
export const appRoutes: Route[] = [
    ...
    { path: '', pathMatch: 'full', redirectTo: 'features/collaborator' },
                ...
                children: [
                    {
                        ...
                        loadChildren: () =>
                            import(
                                'app/modules/admin/features/collaborator/collaborator.routes'
                            ),
                    },
                    {
                        path: 'feature2',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/features/feature2/feature2.routes'
                            ),
                    },
                    {
                        path: 'feature3',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/features/feature3/feature3.routes'
                            ),
                    },
                    {
                        path: 'feature4',
                        loadChildren: () =>
                            import(
                                'app/modules/admin/features/feature4/feature4.routes'
                            ),
                    },
                ],
            },
